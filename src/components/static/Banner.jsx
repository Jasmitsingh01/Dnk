...
function Banner() {
  return (
<section className=" relative bg-banner-1 w-full bg-center bg-cover px-2 min-h-[80vh] lg:min-h-[100vh] before:absolute before:h-full before:w-full before:top-0 before:-left-0 before:bg-banner-overlay before:z-10 z-0  flex  items-center  lg:bg-fixed lg:w-full ">
